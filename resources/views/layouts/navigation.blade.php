        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('dubsync.index')" :active="request()->routeIs('dubsync.*')">
                        DubSync
                    </x-nav-link>
            ...
            @guest
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <a href="{{ route('login') }}"
                        class="inline-flex items-center px-4 py-2 border border-primary text-sm font-semibold rounded-md text-primary bg-white hover:bg-primary hover:text-white transition ease-in-out duration-150">
                        Đăng nhập
                    </a>
                </div>
            @endguest
